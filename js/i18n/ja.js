export default {
  ...
  "ui.showSlotColors": "スロット別に色分け",
  "ui.slotLegendNone": "テクスチャなし",
  "ui.showOverlaps": "重複を表示",
  "ui.copyMaterial": "マテリアルをコピー",
  "tooltips.copyMaterial": "このスロットのマップと設定を別のスロットに適用します。適用先は自身の選択面をそのまま保持します。クリックしてから適用先のスロットをクリックしてください。ダブルクリックで複数のスロットに続けて適用でき、Esc でキャンセルします。",
  "toasts.brushArmed": "マテリアルブラシ: {name}",
  "toasts.brushHint": "スロットをクリックで適用 · Esc でキャンセル",
  "toasts.brushHintSticky": "複数スロットに適用できます · Esc でキャンセル",
  "toasts.brushKept": "マテリアルを適用しました — 選択面は保持（{n} 三角形）",
  "toasts.brushNoMaterial": "このスロットにはコピーできるマップも設定もありません",
  "tooltips.showSlotColors": "テクスチャが適用された各面を、所有するスロットの色で塗り分けます（エクスポートと同じ規則：複数のスロットが要求する面は最初のスロットのもの）。色なし = テクスチャなし。",
  ...
  "labels.textureSizeU": "サイズ U (mm)",
  "labels.textureSizeV": "サイズ V (mm)",
  "tooltips.textureSize": "テクスチャ1リピートの物理サイズ（ミリメートル）。同じ値ならどのモデルでも同じ物理サイズの模様になります。",
  ...
  "ui.pieceCountStep": "<b>{n}</b> 個のパーツ（STEP のソリッド由来、正確）。",
  "ui.previewActiveSlot": "このスロットをプレビュー",
  "tooltips.previewActiveSlot": "「Preview All Slots」と同じ実計算を、作業中のスロットだけに対して行います。ひとつの素材を追い込むときはこちらが大幅に高速です。",
  "ui.previewAllSlots": "すべてのスロットをプレビュー",
  "ui.exitPreview": "プレビューを終了",
  "ui.pieceHeading": "パーツごとの変化 ⓘ",
  "tooltips.piece": "分かれた部品ごとにテクスチャの別の場所を割り当て、扉のすべての板を木目が一直線に貫くのをやめさせます。0 のときは以前とまったく同じ挙動です。",
  "labels.pieceOffset": "ずらし",
  "tooltips.pieceOffset": "各パーツをテクスチャ内でどれだけずらすか。0 = オフ、以前とまったく同じ挙動です。",
  "labels.pieceRotate": "傾き（度）",
  "tooltips.pieceRotate": "パーツごとのランダムな傾き（±この角度）。板なら 2〜3 度で十分です。",
  "labels.pieceMinSize": "部材の最小サイズ (mm) ⓘ",
  "tooltips.pieceMinSize": "これより小さい部材は変化しません。部材の最も長い辺で判定します（板は長く、鋲は三軸とも小さい）。0 なら閾値なしで、どんなに小さくても変化します。",
  "labels.levelsAuto": "レベルを伸ばす",
  "tooltips.levelsAuto": "マップが実際に使っている範囲を測り、黒点と白点を設定して伸ばします。0..255 の一部しか使わないマップは、その分だけ凹凸が浅くなります。",
  "ui.levelsStretched": "使用範囲 <b>{pct} %</b>。レベルを伸ばしました。凹凸 <b>x{gain}</b>。",
  "ui.levelsFlat": "使用範囲 <b>{pct} %</b> — 狭すぎるため、ノイズを増幅せずに伸ばせません。",
  "ui.levelsNoMap": "測定するマップがありません。",
  "labels.pieceFlip": "部材をランダムに反転 ⓘ",
  "tooltips.pieceFlip": "およそ半数の部材を無作為に前後反転します。指物師が板を交互にするのと同じ考えですが、厳密な交互ではありません（モデルの部材に自然な順序はないため）。",
  "labels.pieceReseed": "引き直す",
  "tooltips.pieceReseed": "別のランダムなずらし方を引き直します。同じシードなら結果は常に同じです。",
  "ui.pieceCount": "<b>{n}</b> 個のパーツを検出。この数がおかしい場合、パーツ同士が接している可能性があります。",
  "ui.pieceIgnored": "うち <b>{n}</b> 個は {mm} mm の閾値未満のため、そのままです。",
  "ui.pieceNone": "このモデルのパーツ分割はまだありません。先にモデルを読み込んでください。",
  "ui.mapPrepHeading": "マップの下ごしらえ ⓘ",
  "tooltips.mapPrep": "多くのマップは写真やレンダリングで、細かい粒が大きな形と同じくらいの高さを持っています。ここではサンプリング前にその配分を調整します — 両方まとめて削るしかないスムージングとは違います。",
  "labels.mapMacro": "大きな形",
  "tooltips.mapMacro": "境界サイズより大きい形（石・板・レンガ）へのゲイン。大きな形を読ませたいときに上げます。",
  "labels.mapMicro": "細かい粒",
  "tooltips.mapMicro": "境界サイズより細かいディテール（粒・ノミ跡・写真ノイズ）へのゲイン。表面がパン屑のようになるときは下げます。",
  "labels.mapSplit": "境界サイズ (mm)",
  "tooltips.mapSplit": "大きな形と細かい粒の境目を、モデル上のミリメートルで指定します。いちばん小さい石や板のサイズより少し下に設定してください。",
  "labels.mapBlack": "黒点",
  "tooltips.mapBlack": "これより暗い部分はすべて最も低い点になります。目地を深くしたいときに上げます。",
  "labels.mapWhite": "白点",
  "tooltips.mapWhite": "これより明るい部分はすべて最も高い点になります。石の上面を平らにしたいときに下げます。",
  "labels.mapGamma": "ガンマ",
  "tooltips.mapGamma": "両端を動かさずに中間調を曲げます。1 より大きいと中間の高さが持ち上がり、小さいと下がります。",
  ...
  "labels.creaseAngle": "折れ角（度）",
  "ui.creaseAngleHeading": "シェーディングの折れ角",
  "ui.creaseAngleDesc": "表示のみ — 頂点は動かず、書き出すメッシュも変わりません。この角度より近い隣接面はひと続きの滑らかな面として陰影付けされ、それより鋭い接合はハードエッジのまま残ります。テクスチャの折り目が丸まって見えるなら下げ、まだ面が目立つなら上げてください。",
  "labels.smoothingAuto": "自動（サンプリングレートを測定）",
  "tooltips.smoothingAuto": "メッシュの各エッジがテクスチャ何ピクセル分に相当するかを測り、それに応じてぼかし量を決めます。",
  "ui.smoothingAutoResolved": "<b>{texels}</b> px/エッジ — メッシュはこのマップを解像できています。フィルタ不要です。",
  "ui.smoothingAutoPrefiltered": "<b>{texels}</b> px/エッジ — サンプリング不足ですが、アンチエイリアスが頂点ごとに処理済みです。スムージングは純粋に表現用になります。",
  "ui.smoothingAutoApplied": "<b>{texels}</b> px/エッジ — ぼかしを σ <b>{sigma}</b> px に設定しました。",
  "ui.smoothingAutoClamped": "<b>{texels}</b> px/エッジ — σ {want} px が必要ですが <b>{sigma}</b> で頭打ちです。アンチエイリアスを有効にしてください。",
  ...
  "labels.polarAxis": "アーチ軸",
  "labels.polarCentre": "アーチ中心",
  "labels.cylinderAxis": "シリンダー軸",
  "ui.polarAutofit": "自動調整",
  "ui.cylinderAutofit": "自動フィット",
  "tooltips.polarAutofit": "選択された面に最小二乗で円をあてはめ、アーチの中心と半径を求めます。アーチだけを選んでください。敷居や方立を含む枠全体では円がずれます。",
  "tooltips.cylinderAutofit": "外向きの頂点に円を最小二乗法でフィットさせます。",
  "ui.polarReset": "リセット",
  "ui.cylinderReset": "リセット",
  "tooltips.polarReset": "バウンディングボックスの中心と半径に戻します。",
  ...
  "toasts.closeCancelled": "終了を取り消しました",
  "toasts.saveFailed": "保存に失敗しました: {msg}",
  "toasts.polarFitOk": "アーチ中心を調整しました",
  "toasts.polarFitFail": "調整できません。先にアーチの面を選択してください",
