export default {
  ...
  "ui.showSlotColors": "Colorir por slot",
  "ui.slotLegendNone": "Sem textura",
  ...
  "tooltips.showSlotColors": "Colore cada face texturizada conforme o slot que a possui, com a regra da exportação: uma face reivindicada por vários slots fica com o primeiro. Sem cor = sem textura.",
  ...
  "projection.polar": "Polar (arco / aduelas)",
  ...
  "labels.levelsAuto": "Esticar níveis",
  "tooltips.levelsAuto": "Mede a faixa realmente ocupada pelo mapa e ajusta os pontos preto e branco para esticá-la. Um mapa que ocupa apenas parte de 0..255 rende proporcionalmente menos relevo.",
  "ui.levelsStretched": "Faixa ocupada: <b>{pct} %</b>. Níveis esticados, relevo <b>x{gain}</b>.",
  "ui.levelsFlat": "Faixa ocupada: <b>{pct} %</b> — estreita demais para esticar sem amplificar o ruído.",
  "ui.levelsNoMap": "Nenhum mapa ativo para medir.",
  ...
  "labels.polarAxis": "Eixo do arco",
  "labels.polarCentre": "Centro do arco",
  "labels.cylinderAxis": "Eixo do cilindro",
  "ui.polarAutofit": "Ajustar",
  "ui.cylinderAutofit": "Ajuste automático",
  "tooltips.polarAutofit": "Ajusta um círculo às faces SELECIONADAS (mínimos quadrados) para achar o centro e o raio do arco. Seleciona só o arco: um caixilho inteiro, com soleira e ombreiras, desvia o círculo.",
  ...
  "tooltips.polarReset": "Voltar ao centro e raio da caixa delimitadora.",
  ...
  "toasts.closeCancelled": "Fecho cancelado",
  "toasts.saveFailed": "Falha ao guardar: {msg}",
  "toasts.polarFitOk": "Centro do arco ajustado",
  "toasts.polarFitFail": "Ajuste falhou — seleciona primeiro as faces do arco",
  ...
  "audit.notWatertight": "Malha exportada não fechada: {open} aresta(s) aberta(s), {nm} aresta(s) non-manifold de {edges}. O fatiador talvez feche, mas não é garantido — reduza a amplitude ou a finura de subdivisão, ou repare antes de imprimir.",
  "audit.underNozzle": "Parede mais fina {wall} mm, menos {cut} mm escavados dos dois lados = {after} mm — abaixo do bico de {limit} mm. Solução: amplitude simétrica ≤ {amp} mm, ou engrossar a peça.",
  "audit.thin": "Parede mais fina após a escavação: {after} mm — imprimível, mas abaixo dos {limit} mm confortáveis.",
  "audit.notMeasurable": "Espessura não mensurável: nenhum dos {samples} raios atingiu uma parede oposta (malha aberta ou normais invertidas).",
  "audit.upperBound": "Limite superior: o nível mais escuro real dos mapas não foi medido.",
};
