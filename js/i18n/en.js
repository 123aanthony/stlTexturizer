export default {
  ...
  "ui.showSlotColors": "Colour by Slot",
  "ui.slotLegendNone": "Not textured",
  "ui.showOverlaps": "Show Overlaps",
  "ui.copyMaterial": "Copy Material",
  "tooltips.copyMaterial": "Copy this slot's map and settings onto another slot, which keeps its own selected faces. Click, then click the target slot. Double-click to stay armed for several slots; Esc cancels.",
  "toasts.brushArmed": "Material brush: {name}",
  "toasts.brushHint": "Click a slot to apply · Esc to cancel",
  "toasts.brushHintSticky": "Armed for several slots · Esc to cancel",
  "toasts.brushKept": "Material applied — selection kept ({n} tris)",
  "toasts.brushNoMaterial": "This slot has no map or settings to copy",
  "tooltips.showSlotColors": "Colour every textured face by the slot that owns it, using the export's own rule: a face claimed by several slots goes to the first one. Uncoloured = not textured.",
  ...
  "projection.polar": "Polar (arch / voussoirs)",
  ...
  "ui.pieceCountStep": "<b>{n}</b> pieces, from the STEP solids — exact.",
  "ui.previewActiveSlot": "Preview This Slot",
  "tooltips.previewActiveSlot": "Same real computation as Preview All Slots, but only for the slot you are working on. Much faster when iterating on a single material.",
  "ui.previewAllSlots": "Preview All Slots",
  "ui.exitPreview": "Exit Preview",
  "ui.pieceHeading": "Per-piece variation ⓘ",
  "tooltips.piece": "Gives each separate part its own patch of the texture, so the wood grain stops running straight through every plank of a door. At 0 everything behaves exactly as before.",
  "labels.pieceOffset": "Shift",
  "tooltips.pieceOffset": "How far each piece slides within the texture. 0 = off, exactly the previous behaviour.",
  "labels.pieceRotate": "Tilt (deg)",
  "tooltips.pieceRotate": "Random tilt per piece, plus or minus this many degrees. A couple of degrees is plenty for planks.",
  "labels.pieceMinSize": "Min piece size (mm) ⓘ",
  "tooltips.pieceMinSize": "Pieces smaller than this are left alone. Measured on the piece's largest side: a plank is long, a rivet is small on all three axes. 0 = no threshold, every piece varies however small.",
  "labels.levelsAuto": "Stretch levels",
  "tooltips.levelsAuto": "Measure the range this map actually uses and set the black and white points to stretch it. A map spanning only part of 0..255 yields proportionally less relief.",
  "ui.levelsStretched": "Range used: <b>{pct}%</b>. Levels stretched, relief <b>x{gain}</b>.",
  "ui.levelsFlat": "Range used: <b>{pct}%</b> — too narrow to stretch without amplifying noise.",
  "ui.levelsNoMap": "No active map to measure.",
  "labels.pieceFlip": "Flip random pieces ⓘ",
  "tooltips.pieceFlip": "Turns about half the pieces end for end, drawn at random, the way a joiner alternates boards. Not a strict alternation: the pieces of a model have no natural order.",
  "labels.pieceReseed": "Shuffle",
  "tooltips.pieceReseed": "Draw a different set of random shifts. The same seed always gives the same result.",
  "ui.pieceCount": "<b>{n}</b> pieces detected. If that number looks wrong, the parts are probably touching — see the tooltip.",
  "ui.pieceIgnored": "<b>{n}</b> below the {mm} mm threshold, left untouched.",
  "ui.pieceNone": "No piece breakdown available for this model yet — load a model first.",
  "ui.mapPrepHeading": "Map preparation ⓘ",
  "tooltips.mapPrep": "Most maps are photos or renders, where fine grain carries as much height as the big shapes. These controls rebalance that before sampling — unlike smoothing, which can only remove both at once.",
  "labels.mapMacro": "Big shapes",
  "tooltips.mapMacro": "Gain on shapes coarser than the split size — the stones, planks, bricks. Raise it to make the big forms read.",
  "labels.mapMicro": "Fine grain",
  "tooltips.mapMicro": "Gain on detail finer than the split size — grain, chisel marks, photo noise. Lower it when the surface comes out looking like crumbs.",
  "labels.mapSplit": "Split size (mm)",
  "tooltips.mapSplit": "Where big shapes end and fine grain begins, in millimetres on the model. Set it just under the size of your smallest stone or plank.",
  "labels.mapBlack": "Black point",
  "tooltips.mapBlack": "Everything darker than this becomes the lowest point. Raise it to sink the mortar joints.",
  "labels.mapWhite": "White point",
  "tooltips.mapWhite": "Everything brighter than this becomes the highest point. Lower it to flatten the tops of the stones.",
  "labels.mapGamma": "Gamma",
  "tooltips.mapGamma": "Bends the midtones without moving the extremes. Above 1 lifts the middle heights, below 1 pushes them down.",
  ...
  "labels.creaseAngle": "Crease angle (deg)",
  "ui.creaseAngleHeading": "Shading Crease Angle",
  "ui.creaseAngleDesc": "Display only — no vertex moves, and the exported mesh is unaffected. Neighbouring faces closer than this angle are shaded as one smooth surface; sharper joints stay as hard edges. Lower it if creases in your texture look rounded off, raise it if the surface still looks faceted.",
  "labels.smoothingAuto": "Auto (measure sampling rate)",
  "tooltips.smoothingAuto": "Measures how many texture pixels each mesh edge spans, then sizes the blur from it.",
  "ui.smoothingAutoResolved": "<b>{texels}</b> px/edge — the mesh resolves this map. No filtering needed; blurring would only destroy detail your export can carry.",
  "ui.smoothingAutoPrefiltered": "<b>{texels}</b> px/edge — undersampled, but antialiasing already handles it per vertex. Smoothing is now purely artistic.",
  "ui.smoothingAutoApplied": "<b>{texels}</b> px/edge — blur set to σ <b>{sigma}</b> px to band-limit the map.",
  "ui.smoothingAutoClamped": "<b>{texels}</b> px/edge — needs σ {want} px, capped at <b>{sigma}</b>. Turn antialiasing on instead.",
  ...
  "labels.polarAxis": "Arch axis",
  "labels.polarCentre": "Arch centre",
  "labels.cylinderAxis": "Cylinder Axis",
  "ui.polarAutofit": "Auto-fit",
  "ui.cylinderAutofit": "Auto-fit",
  "tooltips.polarAutofit": "Fit a circle to the SELECTED faces (least-squares) to find the arch centre and radius. Select the arch alone: a whole frame, sill and jambs included, pulls the circle off.",
  "tooltips.cylinderAutofit": "Fit a circle to the part's outward-facing vertices (least-squares).",
  "ui.polarReset": "Reset",
  "ui.cylinderReset": "Reset",
  "tooltips.polarReset": "Back to the bounding-box centre and radius.",
  ...
  "toasts.closeCancelled": "Close cancelled",
  "toasts.saveFailed": "Save failed: {msg}",
  "toasts.polarFitOk": "Arch centre fitted",
  "toasts.polarFitFail": "Fit failed — select the arch faces first",
