export default {
  ...
  "ui.showSlotColors": "Couleurs par slot",
  "ui.slotLegendNone": "Non texturé",
  ...
  "tooltips.showSlotColors": "Colorie chaque face texturée selon le slot qui la possède, avec la règle de l'export : une face réclamée par plusieurs slots revient à la première. Sans couleur = non texturée.",
  ...
  "projection.polar": "Polaire (arche / claveaux)",
  ...
  "labels.pieceMinSize": "Taille mini de pièce (mm) ⓘ",
  "tooltips.pieceMinSize": "Les pièces plus petites que cette taille ne varient pas. Mesurée sur leur plus grand côté : une planche est longue, un rivet est petit dans les trois axes. 0 = aucun seuil, toute pièce varie, si minuscule soit-elle.",
  "labels.levelsAuto": "Étirer les niveaux",
  "tooltips.levelsAuto": "Mesure la plage réellement occupée par la carte et règle les points noir et blanc pour l'étirer. Une carte qui n'occupe qu'une partie de 0..255 rend proportionnellement moins de relief.",
  "ui.levelsStretched": "Plage occupée : <b>{pct} %</b>. Niveaux étirés, relief <b>×{gain}</b>.",
  "ui.levelsFlat": "Plage occupée : <b>{pct} %</b> — trop étroite pour être étirée sans amplifier le bruit.",
  "ui.levelsNoMap": "Aucune carte active à mesurer.",
  "labels.pieceFlip": "Retourner des pièces au hasard ⓘ",
  "tooltips.pieceFlip": "Retourne environ la moitié des pièces bout pour bout, tirées au sort — comme un menuisier alterne ses planches. Ce n'est pas une alternance stricte : les pièces d'un modèle n'ont pas d'ordre naturel.",
  ...
  "ui.pieceIgnored": "<b>{n}</b> sous le seuil de {mm} mm, laissées telles quelles.",
  ...
  "labels.polarAxis": "Axe de l’arche",
  "labels.polarCentre": "Centre de l’arche",
  "labels.cylinderAxis": "Axe du cylindre",
  "ui.polarAutofit": "Ajuster",
  "ui.cylinderAutofit": "Ajustement auto",
  "tooltips.polarAutofit": "Ajuste un cercle sur les faces SÉLECTIONNÉES (moindres carrés) pour trouver le centre et le rayon de l’arche. Sélectionne l’arche seule : un cadre entier, seuil et montants compris, tire le cercle ailleurs.",
  "tooltips.cylinderAutofit": "Ajuste un cercle aux sommets orientés vers l'extérieur de la pièce (moindres carrés).",
  "ui.polarReset": "Réinitialiser",
  "ui.cylinderReset": "Réinitialiser",
  "tooltips.polarReset": "Revenir au centre et au rayon déduits de la boîte englobante.",
  ...
  "toasts.closeCancelled": "Fermeture annulée",
  "toasts.saveFailed": "Échec de l’enregistrement : {msg}",
  "toasts.polarFitOk": "Centre de l’arche ajusté",
  "toasts.polarFitFail": "Ajustement impossible — sélectionne d’abord les faces de l’arche",
