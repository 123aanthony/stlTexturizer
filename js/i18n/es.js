export default {
  ...
  "ui.showSlotColors": "Colorear por slot",
  "ui.slotLegendNone": "Sin textura",
  "ui.showOverlaps": "Mostrar solapamientos",
  "ui.copyMaterial": "Copiar material",
  "tooltips.copyMaterial": "Aplica el mapa y los ajustes de este slot a otro slot, que conserva sus propias caras seleccionadas. Haz clic y luego haz clic en el slot destino. Doble clic para seguir activo en varios slots; Esc cancela.",
  "toasts.brushArmed": "Pincel de material: {name}",
  "toasts.brushHint": "Haz clic en un slot para aplicar · Esc para cancelar",
  "toasts.brushHintSticky": "Activo para varios slots · Esc para cancelar",
  "toasts.brushKept": "Material aplicado — selección conservada ({n} tris)",
  "toasts.brushNoMaterial": "Este slot no tiene mapa ni ajustes que copiar",
  "tooltips.showSlotColors": "Colorea cada cara texturizada según el slot que la posee, con la regla de la exportación: una cara reclamada por varios slots va al primero. Sin color = sin textura.",
  ...
  "projection.polar": "Polar (arco / dovelas)",
  ...
  "tooltips.textureSize": "Tamaño físico de una repetición de textura en milímetros — el mismo valor produce el mismo tamaño de patrón en cualquier modelo.",
  ...
  "ui.pieceCountStep": "<b>{n}</b> piezas, según los sólidos del STEP — exacto.",
  "ui.previewActiveSlot": "Vista de este slot",
  "tooltips.previewActiveSlot": "El mismo cálculo real que «Preview All Slots», pero solo para el slot en el que trabajas. Mucho más rápido al ajustar un único material.",
  "ui.previewAllSlots": "Vista de todos los slots",
  "ui.exitPreview": "Salir de la vista",
  "ui.pieceHeading": "Variación por pieza ⓘ",
  "tooltips.piece": "Da a cada pieza separada su propio trozo de textura, para que la veta de la madera deje de atravesar de un tirón todas las tablas de una puerta. En 0, todo se comporta exactamente como antes.",
  "labels.pieceOffset": "Desplazamiento",
  "tooltips.pieceOffset": "Cuánto se desplaza cada pieza dentro de la textura. 0 = desactivado, exactamente el comportamiento anterior.",
  "labels.pieceRotate": "Inclinación (grados)",
  "tooltips.pieceRotate": "Inclinación aleatoria por pieza, más o menos estos grados. Con dos o tres grados basta para tablas.",
  "labels.pieceMinSize": "Tamaño mínimo de pieza (mm) ⓘ",
  "tooltips.pieceMinSize": "Las piezas más pequeñas no varían. Se mide el lado mayor de la pieza: una tabla es larga, un remache es pequeño en los tres ejes. 0 = sin umbral, toda pieza varía.",
  "labels.levelsAuto": "Estirar niveles",
  "tooltips.levelsAuto": "Mide el rango que el mapa usa realmente y ajusta los puntos negro y blanco para estirarlo. Un mapa que solo ocupa parte de 0..255 da proporcionalmente menos relieve.",
  "ui.levelsStretched": "Rango usado: <b>{pct} %</b>. Niveles estirados, relieve <b>x{gain}</b>.",
  "ui.levelsFlat": "Rango usado: <b>{pct} %</b> — demasiado estrecho para estirarlo sin amplificar el ruido.",
  "ui.levelsNoMap": "No hay mapa activo que medir.",
  "labels.pieceFlip": "Voltear piezas al azar ⓘ",
  "tooltips.pieceFlip": "Voltea aproximadamente la mitad de las piezas de punta a punta, al azar, como un carpintero alterna las tablas. No es una alternancia estricta: las piezas de un modelo no tienen orden natural.",
  "labels.pieceReseed": "Volver a sortear",
  "tooltips.pieceReseed": "Sortea otro conjunto de desplazamientos. La misma semilla da siempre el mismo resultado.",
  "ui.pieceCount": "<b>{n}</b> piezas detectadas. Si el número parece erróneo, seguramente las piezas se tocan — ver el tooltip.",
  "ui.pieceIgnored": "<b>{n}</b> por debajo del umbral de {mm} mm, sin modificar.",
  "ui.pieceNone": "Todavía no hay desglose en piezas para este modelo — carga primero un modelo.",
  "ui.mapPrepHeading": "Preparación del mapa ⓘ",
  "tooltips.mapPrep": "La mayoría de los mapas son fotos o renders, donde el grano fino aporta tanta altura como las formas grandes. Estos controles reequilibran eso antes del muestreo — a diferencia del suavizado, que solo puede quitar ambos a la vez.",
  "labels.mapMacro": "Formas grandes",
  "tooltips.mapMacro": "Ganancia sobre las formas más grandes que el tamaño de corte — piedras, tablas, ladrillos. Súbelo para que las masas se lean.",
  "labels.mapMicro": "Grano fino",
  "tooltips.mapMicro": "Ganancia sobre el detalle más fino que el tamaño de corte — grano, marcas de cincel, ruido de la foto. Bájalo cuando la superficie salga como migas.",
  "labels.mapSplit": "Tamaño de corte (mm)",
  "tooltips.mapSplit": "Dónde acaban las formas grandes y empieza el grano, en milímetros sobre el modelo. Ponlo justo por debajo del tamaño de tu piedra o tabla más pequeña.",
  "labels.mapBlack": "Punto negro",
  "tooltips.mapBlack": "Todo lo más oscuro pasa a ser el punto más bajo. Súbelo para hundir las juntas.",
  "labels.mapWhite": "Punto blanco",
  "tooltips.mapWhite": "Todo lo más claro pasa a ser el punto más alto. Bájalo para aplanar la parte superior de las piedras.",
  "labels.mapGamma": "Gamma",
  "tooltips.mapGamma": "Curva los medios tonos sin mover los extremos. Por encima de 1 eleva las alturas medias, por debajo las baja.",
  ...
  "labels.creaseAngle": "Ángulo de pliegue (grados)",
  "ui.creaseAngleHeading": "Ángulo de pliegue del sombreado",
  "ui.creaseAngleDesc": "Solo visualización — ningún vértice se mueve y la malla exportada no cambia. Las caras vecinas por debajo de este ángulo se sombrean como una única superficie lisa; las uniones más marcadas siguen siendo aristas vivas. Bájalo si los pliegues de tu textura se ven redondeados, súbelo si la superficie sigue facetada.",
  "labels.smoothingAuto": "Auto (medir la tasa de muestreo)",
  "tooltips.smoothingAuto": "Mide cuántos píxeles de textura abarca cada arista de la malla y dimensiona el desenfoque a partir de ahí.",
  "ui.smoothingAutoResolved": "<b>{texels}</b> px/arista — la malla resuelve este mapa. No hace falta filtrar; desenfocar solo destruiría detalle.",
  "ui.smoothingAutoPrefiltered": "<b>{texels}</b> px/arista — submuestreado, pero el antialiasing ya lo resuelve por vértice. El suavizado es ahora puramente artístico.",
  "ui.smoothingAutoApplied": "<b>{texels}</b> px/arista — desenfoque ajustado a σ <b>{sigma}</b> px.",
  "ui.smoothingAutoClamped": "<b>{texels}</b> px/arista — haría falta σ {want} px, limitado a <b>{sigma}</b>. Mejor activa el antialiasing.",
  ...
  "labels.polarAxis": "Eje del arco",
  "labels.polarCentre": "Centro del arco",
  "labels.cylinderAxis": "Eje del cilindro",
  "ui.polarAutofit": "Ajustar",
  "ui.cylinderAutofit": "Auto-ajuste",
  "tooltips.polarAutofit": "Ajusta un círculo a las caras SELECCIONADAS (mínimos cuadrados) para hallar el centro y el radio del arco. Selecciona solo el arco: un marco completo, con umbral y jambas, desvía el círculo.",
  "tooltips.cylinderAutofit": "Ajusta un círculo a los vértices exteriores de la pieza (mínimos cuadrados).",
  "ui.polarReset": "Restablecer",
  "ui.cylinderReset": "Restablecer",
  "tooltips.polarReset": "Volver al centro y radio de la caja envolvente.",
  ...
  "toasts.closeCancelled": "Cierre cancelado",
  "toasts.saveFailed": "Error al guardar: {msg}",
  "toasts.polarFitOk": "Centro del arco ajustado",
  "toasts.polarFitFail": "Ajuste imposible: selecciona antes las caras del arco",
  ...
  "matlib.rememberBtn": "Recordar materiales",
