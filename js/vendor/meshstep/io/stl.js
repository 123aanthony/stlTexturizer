...
export function readBinarySTL(bytes) {
    ...
    for (let i = 0; i < count; i++) {
        ...
        for (let k = 0; k < 9; k++)
            positions[base + k] = dv.getFloat32(o + 12 + k * 4, true);
...
export function writeBinarySTL(mesh, header = "meshStep binary STL") {
...
export function indexSoup(soup, eps = 1e-6) {
