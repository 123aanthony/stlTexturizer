...
export function tokenize(src) {
    ...
    while (i < n) {
        ...
        if (c === "(")
            ...
            toks.push({ kind: "semi", text: c, pos: start });
        else if (c === "=")
            toks.push({ kind: "eq", text: c, pos: start });
        else if (c === "$")
            toks.push({ kind: "dollar", text: c, pos: start });
        else if (c === "*")
            toks.push({ kind: "star", text: c, pos: start });
